...
# and simulation snapshot
    ...
    def __init__(self, filename, ptype):
        ...
        self.x = (self.data["x"][self.index]) #grab x values
        self.y = self.data["y"][self.index] #grab y values
        self.z = self.data["z"][self.index] #grab z values
