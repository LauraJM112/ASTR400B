...
cly_r = np.sqrt(x**2+y**2) #radial coordinate
...
print(f"{b_half:.2e}") #close enough
...
ax.loglog(r_annuli, SersicM31Bulge/1e10, linestyle='-.', lw=3, 
          label = "Sersic n=4") #something is not right here of in Sersic M31Bulge
