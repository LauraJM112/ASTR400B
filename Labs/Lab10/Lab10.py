...
class M33AnalyticOrbit:
    ...
    def __init__(self, filename):
        ...
        self.M33halo = ComponentMass("M33_000.txt", 1)*1e12 #M33 halo mass is Msun
    
        ### ADD M31 CIRCULAR SPEED HERE ### 
        self.Vc = 180 #circular speed of M31 halo (HW5)
    ...
    def DymanicalFriction(self, Msat, Vc, r, v):
        '''
        a method that returns the deceleration from dynamical friction felt by 
        M33 owing to its motion through the dark matter halo of M31
        ...
        r : np.ndarray
            the position vector of the sattellite relative  to the host (kpc)
        v : np.ndarray
            velocity vector of the sattellite relative to the host (km/s)

        Returns
        -------
        DF: np.ndarray
            deceleration vector owing to dynmaical friction
    ...
    def M31Accel(self, r, v):
        ...
        r : `np.ndarray`
            Position vector to find the acceleration (kpc)
        v : 'np.ndarray'
            Velocity vector for dynamical friction calculation (km/s)
        ...
        aDF = self.DymanicalFriction(self.M33halo, self.Vc, r, v)
...
if __name__ == '__main__':
    ...
    ax.plot(M33Orbit['t'], M31_M33_R, 'g', lw=5, linestyle='--', 
            label = 'M31-M33 with DF')
