...
# Define k_B in EV/K, put boltzmann constant in corrent unints
...
z_guess = 19300 #ish
T_recombine = BenchMark.Temperature(z_guess)
print(T_recombine)

# So why doesn't recombination occur then? - see lecture 

#Its a blackbody! there is a distibution of wavelengths and not the same amount of photons as hydrogen atoms
#its more about density? than temperature
...
HorizonRecombine = BenchMark.ProperDistance(z_recombine, 2e4)
...
#the CMB should only be uniform over 2 deg but it is uniform over the entire sky --> inflation!
#%%
1/(70*u.km/u.s/u.Mpc).to(1/u.Gyr) # sidenote: hubble parameter is 1/age of the universe
#%%
# # Part 3, Question 2
...
SoundHorizon = BenchMark.SoundHorizon(z_recombine, 2e4)
print(SoundHorizon)

#sound horizon today 
#Properdistance = comoving radial distance/1+z
SoundHorizonToday = SoundHorizon*(1+z_recombine)
print(SoundHorizonToday)
#%%
#sound horizon in Einstein DeSitter
SoundHorizonED = EDeSitter.SoundHorizon(z_recombine, 2e4)
