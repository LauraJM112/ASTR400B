...
plt.plot(data11['B']-data11['R'], data11['R'], color='lightslategray', linewidth=5, label='11 Gyr')

#secondary peak
filename7 = "./IsochroneData/Isochrone7.txt"
data7 = np.genfromtxt(filename7, dtype=None, names = True, skip_header=8)
plt.plot(data7['B']-data7['R'], data7['R'], color='gold', linewidth=5, label='7 Gyr')

filename8 = "./IsochroneData/Isochrone8.txt"
data8 = np.genfromtxt(filename8, dtype=None, names = True, skip_header=8)
plt.plot(data8['B']-data8['R'], data8['R'], color='darkturquoise', linewidth=5, label='6 Gyr')
...
#  we don't have data for younger ages

# # Q3
# 
# What do you think might cause the bursts of star formation?
# Partial galaxy merger, sudden gas cooling, older star death kickstarting 
